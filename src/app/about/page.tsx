...
export default function About() {
  return (
    <div className="flex flex-col w-full bg-white text-black font-sans selection:bg-purple/20">
      ...
      {/* ── STORY SECTION ── */}
      <section className="pt-4 pb-12 px-6 md:px-12 lg:px-24 bg-white">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start">
            ...
            >
              ...
              <motion.div
                variants={fadeUp}
                className="space-y-6 font-sans text-black text-lg md:text-xl leading-[1.9] font-light"
              >
                <p>
                ...
                <p className="text-black font-medium text-2xl leading-[1.5]">
              ...
              <motion.div
                variants={fadeUp}
                className="mt-12 pt-8 border-t border-black/5 grid grid-cols-3 gap-4 md:gap-8 items-start"
              >
                {credentials.map((c, i) => (
                  <div key={i} className="group flex flex-col gap-3 cursor-default">
                    <span className="font-serif text-4xl md:text-5xl text-black group-hover:text-purple group-hover:-translate-y-1 transition-all duration-500">
                      {c.value}
                    </span>
                    <span className="text-[10px] uppercase tracking-[0.2em] font-medium text-black leading-relaxed group-hover:text-purple/80 transition-colors duration-500">
                      {c.label}
                    </span>
                  </div>
                ))}
      ...
      {/* ── MISSION BANNER ── */}
      <section className="py-12 md:py-6 px-6 bg-white relative overflow-hidden text-black border-y border-black/5">
        ...
        >
          <motion.div
            ...
            className="font-serif text-8xl text-purple/20 leading-none mb-8 select-none inline-block origin-center"
          >
            &quot;
          </motion.div>
          <p className="font-serif text-3xl md:text-4xl lg:text-5xl leading-[1.5] text-black mb-12 font-medium flex flex-wrap justify-center gap-x-[0.3em] gap-y-2">
          ...
          <div className="inline-flex flex-col items-center gap-4">
            <span className="w-px h-10 bg-purple/30" />
            <p className="text-[11px] uppercase tracking-[0.3em] font-medium text-purple">The Quiet to Quite Mission</p>
          </div>
        </motion.div>
      </section>

      {/* ── WHAT SETS US APART ── */}
      <section className="py-12 md:py-6 px-6 md:px-12 lg:px-24 bg-white relative">
        <div className="max-w-[1400px] mx-auto">
          <motion.div
          ...
          >
            ...
            <motion.h2 variants={fadeUp} className="font-serif text-4xl md:text-5xl lg:text-[4rem] text-black leading-[1.05] mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
            {values.map((v, i) => (
              <motion.div
                ...
                variants={fadeUp}
                className="group p-10 bg-white border border-black/5 hover:border-purple/40 hover:shadow-2xl transition-all duration-700"
              >
                <div className="text-purple/50 mb-8 text-[12px] group-hover:text-purple transition-colors duration-700">
                  {v.icon}
                </div>
      ...
      <section className="py-12 bg-white relative border-t border-black/5 overflow-hidden">
        <div className="absolute inset-0 pointer-events-none">
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-purple/[0.04] blur-[120px] rounded-full" />
        </div>
        <div className="max-w-[1400px] mx-auto section-px relative z-10">
          ...
          <h2 className="font-serif text-4xl md:text-5xl lg:text-[4rem] text-black leading-[1.05] text-center mb-6">
            The Quiet Shift.
          </h2>
